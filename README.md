...
To begin, view "Data_processing.ipynb" to view the data cleaning script for this project. Using that code, we compressed the raw data with 4285629 rows into 
